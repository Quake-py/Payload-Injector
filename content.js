...
function initializeLocalContentScript() {
  ...
  function injectValueEnhanced(element, value) {
    ...
    // 1. AŞAMA: Pano / Yapıştırma (Clipboard Paste) Simülasyonu (En Güçlü Framework Aşma Yöntemi)
    try {
    ...
    if (element.tagName === "INPUT" || element.tagName === "TEXTAREA") {
      ...
      // 3. AŞAMA: Karakter Karakter Klavye Tuş Vuruşu Gönderme (Tetikleyicileri Uyandırmak İçin)
